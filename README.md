...
QNRTC 是七牛云推出的一款适用于 Windows 平台的实时音视频 SDK，提供了包括音视频通话、美颜、滤镜、水印等多种功能，提供灵活的接口，支持高度定制以及二次开发。
...
# 6 开发文档
请参考开发文档：[QNRTC 开发文档](Documents/QNRTC.md)
...
您可以通过[下载安装我们的 demo 应用『牛会议』]()，体验通话效果。
