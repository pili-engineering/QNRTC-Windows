# QNRTCWin Release Notes for 4.0.0
...
自 4.0.0 后，我们为了提高用户阅读文档的体验，使用了新的文档站（老文档地址继续保留），新文档站地址https://developer.qiniu.com/rtc
...
- [Demo 体验下载地址](https://sdk-release.qnsdk.com/Windows-RTC-4.0.0.zip) 
